                            ...
                            <div class="card-body p-5">
                                <div class="row g-3">
                                    <div class="d-flex flex-column align-items-center text-center">
                                        <?php if($query["account_img"] === ""){echo '<img src="public/images/users/user.png" alt="Admin" class="rounded-circle p-1 bg-primary" width="110">';
                                        }else{ echo '<img src="public/images/users/'. $query["account_img"] .'" alt="Admin" class="rounded-circle p-1 bg-primary" width="110">';} ?>
                                    </div>
                                    <hr>
                                    <div class="col-12">
