<?php
	...
	for($i=1; $i <= count($log_token); $i++){
		...
		curl_setopt( $chOne, CURLOPT_POSTFIELDS, "message=".strval($sMessage));
		$headers = array( 'Content-type: application/x-www-form-urlencoded', 'Authorization: Bearer '.$log_token[$i-1].'', );
