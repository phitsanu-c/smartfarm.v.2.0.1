...
?>
    ...
    <?php if($_POST["count_cn"] != 0){?>
        ...
        <div class="modal fade" id="Modal_control"  tabindex="-1" aria-hidden="true" data-backdrop="static" data-keyboard="false">
			<div class="modal-dialog modal-dialog-centered" style="overflow-y: scroll; max-height:85%;  margin-top: 50px; margin-bottom:50px;"><!-- style="overflow-y: scroll; max-height:85%;  margin-top: 50px; margin-bottom:50px;" -->
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <!-- ========================================= -->
                         <!-- Control 1 -->
                         <div class="">
                            <div class="row" style="background-color: #e0e6e9e3; text-align: justify;">
                                <!-- <div class="child"> -->
                                    <h4 class="col-6"><b class="text_load_1">wdwfwegergr</b></h4>
                                <!-- </div> -->
                                <a class="col-6 text-rigth edit_cont" href="javascript:void(0)" status="1">
                                    <h4><b>Edit</b></h4>
                                </a>
