        ...
        <tbody>
            <?php
                ...
                while ($row = $stmt->fetch()) {
                    ...
                    if($colcount >= 9){ if($row[9] == 'ON'){ echo '<td class="text-center text-success">เปิด</td>'; }else { echo '<td class="text-center text-danger">ปิด</td>'; } }
                    if($colcount >= 10){ if($row[10] == 'ON'){ echo '<td class="text-center text-success">เปิด</td>'; }else { echo '<td class="text-center text-danger">ปิด</td>'; } }
                    if($colcount >= 11){ if($row[11] == 'ON'){ echo '<td class="text-center text-success">เปิด</td>'; }else { echo '<td class="text-center text-danger">ปิด</td>'; } }
                    if($colcount >= 12){ if($row[12] == 'ON'){ echo '<td class="text-center text-success">เปิด</td>'; }else { echo '<td class="text-center text-danger">ปิด</td>'; } }
                    if($colcount >= 13){ if($row[13] == 'ON'){ echo '<td class="text-center text-success">เปิด</td>'; }else { echo '<td class="text-center text-danger">ปิด</td>'; } }
                    if($colcount >= 14){ if($row[14] == 'ON'){ echo '<td class="text-center text-success">เปิด</td>'; }else { echo '<td class="text-center text-danger">ปิด</td>'; } }
                    if($colcount >= 15){ if($row[15] == 'ON'){ echo '<td class="text-center text-success">เปิด</td>'; }else { echo '<td class="text-center text-danger">ปิด</td>'; } }
                    echo '</tr>';
                }
            ?>
        </tbody>
