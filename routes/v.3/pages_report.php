            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mode_sn">
                        ...
                        <div class="row">
                            <?php if($_POST['count_temp'] > 0){?>
                                <div class="col-lg-3 col-xl-3 col-sm-12 d-flex">
                                    <div class="card-body border radius-10 shadow-none mb-3">
                                        <div class="form-check">
                                            <input class="form-check-input" name="radio_c" id="radio_temp" type="radio" onchange="ch_radio('temp')" <?php if($_POST['count_temp'] > 0){echo 'checked';}?>>
                                            <h5>อุณหภูมิ</h5>
                                            <div class="form-check mb-3">
                                                <input type="checkbox" class="form-check-input" name="checkbox_all_temp" onchange="checkbox_all('temp')" <?php if($_POST['count_temp'] > 0){echo 'checked';}?>>
                                                <label class="form-check-label">เลือกทั้งหมด </label>
                                            </div>
                                            <hr/>
                                            <?php for($i=1; $i <= count($dashStatus); $i++ ){
                                                if($dashStatus[$i] == 1){
                                                    if($dashMode[$i] == 1){ ?>
                                                        <div class="form-check mb-3">
                                                            <input type="checkbox" class="form-check-input" name="checkbox_temp[]" value="<?= $dashSncanel[$i] ?>" d_name="<?= $dashName2[$i]." (℃)" ?>" d_mode="<?= $dashSncanel[$i] ?>" onchange="checkbox_check(<?= $_POST['count_temp'] ?> ,'temp')" checked>
                                                            <label class="form-check-label"><?= $dashName2[$i] ?></label>
                                                        </div>
                                            <?php } } } ?>
                                        </div>
                                    </div>
                                </div>
                            <?php } if($_POST['count_hum'] > 0){?>
                                <div class="col-lg-3 col-xl-3 col-sm-12 d-flex">
                                    <div class="card-body border radius-10 shadow-none mb-3">
                                        <div class="form-check">
                                            <input class="form-check-input" name="radio_c" id="radio_hum" type="radio" onchange="ch_radio('hum')" <?php if($_POST['count_temp'] == 0 && $_POST['count_hum'] > 0){echo 'checked';}?>>
                                            <h5>ความชื้นอากาศ</h5>
                                            <div class="form-check mb-3">
                                                <input type="checkbox" class="form-check-input" name="checkbox_all_hum" onchange="checkbox_all('hum')" <?php if($_POST['count_temp'] == 0 && $_POST['count_hum'] > 0){echo 'checked';}?>>
                                                <label class="form-check-label">เลือกทั้งหมด</label>
                                            </div>
                                            <hr/>
                                            <?php for($i=1; $i <= count($dashStatus); $i++ ){
                                                if($dashStatus[$i] == 1){
                                                    if($dashMode[$i] == 2){ ?>
                                                        <div class="form-check mb-3">
                                                            <input type="checkbox" class="form-check-input" name="checkbox_hum[]" value="<?= $dashSncanel[$i] ?>" d_name="<?= $dashName2[$i]." (%Rh)" ?>" d_mode="<?= $dashMode[$i] ?>" onchange="checkbox_check(<?= $_POST['count_hum'] ?> ,'hum')" <?php if($_POST['count_temp'] == 0 && $_POST['count_hum'] > 0){echo 'checked';} ?> >
                                                            <label class="form-check-label"><?= $dashName2[$i] ?></label>
                                                        </div>
                                            <?php } } } ?>
                                        </div>
                            ...
                            <?php } if($_POST['count_light'] > 0){?>
                                <div class="col-lg-3 col-xl-3 col-sm-12 d-flex">
                                    <div class="card-body border radius-10 shadow-none mb-3">
                                        <div class="form-check">
                                            <input class="form-check-input" name="radio_c" id="radio_light" type="radio" onchange="ch_radio('light')" <?php if($_POST['count_temp'] == 0 && $_POST['count_hum'] == 0 && $_POST['count_light'] > 0){echo 'checked';}?>>
                                            <h5>ความเข้มแสง</h5>
                                            <div class="form-check mb-3">
                                                <input type="checkbox" class="form-check-input" name="checkbox_all_light" onchange="checkbox_all('light')" <?php if($_POST['count_temp'] == 0 && $_POST['count_hum'] == 0 && $_POST['count_light'] > 0){echo 'checked';}?>>
                                                <label class="form-check-label">เลือกทั้งหมด</label>
                                            </div>
                                            <hr/>
                                            <?php for($i=1; $i <= count($dashStatus); $i++ ){
                                                if($dashStatus[$i] == 1){
                                                    if($dashMode[$i] == 4){
                                                        echo '<div class="form-check mb-3">
                                                                <input type="checkbox" class="form-check-input" name="checkbox_light[]" value="'.$dashSncanel[$i] .'" d_name="'. $dashName2[$i].' (KLux)" d_mode="'. $dashMode[$i] .'" onchange="checkbox_check('. $_POST['count_light'] .' ,"light")" ';
                                                                if($_POST['count_temp'] == 0 && $_POST['count_hum'] == 0 && $_POST['count_light'] > 0){echo 'checked';} echo '>';
                                                                echo '<label class="form-check-label">'.$dashName2[$i].'</label>
                                                            </div>';
                                                    }else if($dashMode[$i] == 5){
                                                        echo '<div class="form-check mb-3">
                                                                <input type="checkbox" class="form-check-input" name="checkbox_light[]" value="'.$dashSncanel[$i] .'" d_name="'. $dashName2[$i].' (µmol m<sup>-2</sup>s<sup>-1</sup>)" d_mode="'. $dashMode[$i] .'" onchange="checkbox_check('.$_POST['count_light'] .' ,"light")" ';
                                                                if($_POST['count_temp'] == 0 && $_POST['count_hum'] == 0 && $_POST['count_light'] > 0){echo 'checked';} echo '>';
                                                                echo '<label class="form-check-label">'.$dashName2[$i].'</label>
                                                            </div>';
                                                    }
                                                    ...
                                                    //     echo '<div class="form-check mb-3">
                                                    //             <input type="checkbox" class="form-check-input" name="checkbox_light[]" value="'.$dashSncanel[$i] .'" d_name="'. $dashName2[$i].'" d_mode="'. $dashMode[$i] .'" onchange="checkbox_check('. $_POST['count_light'] .' ,"light")" ';
                                                    //             if($_POST['count_temp'] == 0 && $_POST['count_hum'] == 0 && $_POST['count_light'] > 0){echo 'checked';} echo '>';
                                                    //             echo '<label class="form-check-label">'.$dashName2[$i].'</label>
                                                    //         </div>';
                                                    // }
                            ...
                            <?php } if($_POST['count_soil'] > 0){?>
                                <div class="col-lg-3 col-xl-3 col-sm-12 d-flex">
                                    <div class="card-body border radius-10 shadow-none mb-3">
                                        <div class="form-check">
                                            <input class="form-check-input" name="radio_c" id="radio_soil" type="radio" onchange="ch_radio('soil')" <?php if($_POST['count_temp'] == 0 && $_POST['count_hum'] == 0 && $_POST['count_light'] == 0 && $_POST['count_soil'] > 0){echo 'checked';}?>>
                                            <h5>ความชื้นในดิน</h5>
                                            <div class="form-check mb-3">
                                                <input type="checkbox" class="form-check-input" name="checkbox_all_soil" onchange="checkbox_all('soil')" <?php if($_POST['count_temp'] == 0 && $_POST['count_hum'] == 0 && $_POST['count_light'] == 0 && $_POST['count_soil'] > 0){echo 'checked';}?>>
                                                <label class="form-check-label">เลือกทั้งหมด</label>
                                            </div>
                                            <hr/>
                                            <?php for($i=1; $i <= count($dashStatus); $i++ ){
                                                if($dashStatus[$i] == 1){
                                                    if($dashMode[$i] == 3){ ?>
                                                        <div class="form-check mb-3">
                                                            <input type="checkbox" class="form-check-input" name="checkbox_soil[]" value="<?= $dashSncanel[$i] ?>" d_name="<?= $dashName2[$i]." (%)" ?>" d_mode="<?= $dashMode[$i] ?>" onchange="checkbox_check(<?=  $_POST['count_soil'] ?> ,'soil')" <?php if($_POST['count_temp'] == 0 && $_POST['count_hum'] == 0 && $_POST['count_light'] == 0 && $_POST['count_soil'] > 0){echo 'checked';}?>>
                                                            <label class="form-check-label"><?= $dashName2[$i] ?></label>
                                                        </div>
                                            <?php } } } ?>
                                        </div>
...
<script>
    ...
    function report_sn(c_menu){
        ...
        function report_table_sn(val, mode_dwm){
            ...
            $.ajax({
                type: "POST",
                url: "routes/v.3/get_re_table.php",
                data: {
        ...
        function report_chart_sn(val, mode_dwm){
            var options = {
                ...
                colors: ['#e51c23', '#f8bbd0', '#9c27b0', '#673ab7', '#ce93d8', '#00bcd4', '#009688', '#259b24', '#72d572', '#8bc34a', '#cddc39', '#ffeb3b', '#ffc107', '#ff5722', '#795548', '#9e9e9e', '#F6C8B6', '#D3AD79', '#6c2c10', '#3a3420'],
                // series: [{
                //   data: data.slice()
                // }],
                series: [],
            ...
            $.ajax({
                type: "POST",
                url: "routes/v.3/get_report_chart.php",
                data: {
                    house_master: house_master,
                    mode : mode_dwm,
                    mode_report: $('#mode_report').val(),
