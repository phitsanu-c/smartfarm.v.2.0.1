    ...
    <table id="table_compare" class="table table-striped table-bordered dataTable" style="width:100%">
        ...
        <tbody>
            <?php
                ...
                $sql = "SELECT $channel1 FROM tb_data_sensor WHERE data_sn = '$house_master' AND data_timestamp BETWEEN '$start_day' AND '$stop_day' AND mod(minute(`data_timestamp`),'$sel_all_every') = 0 ORDER BY data_timestamp ";
